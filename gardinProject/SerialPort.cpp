...
bool SerialPort::read(char* buf, const unsigned int n, const unsigned int timeout, const unsigned int sInterval)
{
    unsigned int index = 0;
    const unsigned long time = currentTimeMs() + timeout;
